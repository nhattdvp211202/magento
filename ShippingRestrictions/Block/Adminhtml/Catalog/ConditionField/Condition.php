...
namespace Tigren\ShippingRestrictions\Block\Adminhtml\Catalog\ConditionField;
...
class Condition extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        \Tigren\ShippingRestrictions\Model\ShippingFactory $ShippingFactory,
        array $data = []
    ) {
    ...
    private function getRuleFactory()
    {
        if ($this->ruleFactory === null) {
            $this->ruleFactory = ObjectManager::getInstance()->get('Tigren\ShippingRestrictions\Model\ShippingFactory');
        }
    ...
    protected function addTabToForm(
        ...
        $formName = 'shippingrestrictions_form'
    ) {
        if (!$model) {
