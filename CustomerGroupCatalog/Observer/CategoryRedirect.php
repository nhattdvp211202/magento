...
class CategoryRedirect implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        if ($categoryId) {
            ...
            if ($category && $category->getName() === 'History Rule') {
                // Chuyển hướng đến trang history rule
                $observer->getControllerAction()->getResponse()->setRedirect('/tigrencustomergroupcatalog/history');
            }
        }
    }
}
